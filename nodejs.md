...
9. [Node.js 包教不包会](https://github.com/alsotang/node-lessons)
10. [Node.js 应用故障排查手册](https://github.com/aliyun-node/Node.js-Troubleshooting-Guide)
11. [orm2 中文文档](https://github.com/wizardforcel/orm2-doc-zh-cn)
12. [Node.js 教程目录](https://github.com/Wscats/node-tutorial)
13. [基于 Node.js 的 HTTPS MITM(中间人)代理的原理和实现](https://github.com/wuchangming/https-mitm-proxy-handbook)
14. [node 源码粗读系列](https://github.com/xtx1130/blog)
15. [作为一个前端工程师也要掌握的几种文件路径知识](https://mp.weixin.qq.com/s/-jvfO83oA9qHFdzDkjyL9A)
...
18. [Node.js 技术栈](https://github.com/Q-Angelo/Nodejs-Roadmap)
19. [深入理解 Node.js 进程与线程(8000 长文彻底搞懂)](https://segmentfault.com/a/1190000020077274)
...
29. [深入理解 Node.js：核心思想与源码分析](https://yjhjstz.gitbooks.io/deep-into-node/content/)
30. [nodejs](https://github.com/fairyly/mynodejs)
